...
/**
 * @class LossFcts
 * @brief Class implementing loss functions for neural networks.
 */
class LossFcts
{
public:
     ...
     * @param predictions A shared pointer to a Matrix containing the predicted probabilities. (size: batch_size x num_classes)
     * @param targets A shared pointer to a Matrix containing the true labels. (size: batch_size x num_classes)
    ...
    /**
     * @brief Calculates the backward pass of the cross-entropy loss combined with the softmax activation.
