...
class Layer{
    private:
        ...
        std::vector<std::vector<double>> weight_cache; 
        std::vector<std::vector<double>> bias_momentums; 
        std::vector<std::vector<double>> bias_cache; 
    ...
    public:
        ...
        /**
         * @brief Prints the object values.
         * @param matrix vector of vectors.
         */
